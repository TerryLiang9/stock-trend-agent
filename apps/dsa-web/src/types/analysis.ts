...
export const getSentimentColor = (score: number): string => {
  if (score <= 20) return '#c0392b'; // refined red
  if (score <= 40) return '#d4854a'; // warm copper
  if (score <= 60) return '#c8a55a'; // gold
  if (score <= 80) return '#5a9e6f'; // muted green
  return '#3d8b5e'; // deeper green
};
