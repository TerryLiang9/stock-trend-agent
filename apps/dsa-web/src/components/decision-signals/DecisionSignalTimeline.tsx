  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-3 text-xs text-secondary-text">
        <span className="inline-flex items-center gap-1.5"><span className="h-2.5 w-2.5 rounded-full bg-[#5a9e6f]" />{t('decisionSignals.timelineFamilyBullish')}</span>
        <span className="inline-flex items-center gap-1.5"><span className="h-2.5 w-2.5 rounded-full bg-[#c0392b]" />{t('decisionSignals.timelineFamilyDefensive')}</span>
        <span className="inline-flex items-center gap-1.5"><span className="h-2.5 w-2.5 rounded-full bg-[#c8a55a]" />{t('decisionSignals.timelineFamilyNeutral')}</span>
