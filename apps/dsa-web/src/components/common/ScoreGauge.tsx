...
export const ScoreGauge: React.FC<ScoreGaugeProps> = ({
  ...
  const sentimentConfig = {
    greed: {
      color: '#c8a55a',       // Gold
      glowFilter: 'rgba(200, 165, 90, 0.5)',
      lightColor: '#d4b86a',  // Lighter gold
      lightEndColor: '#b89540', // Darker gold
    },
    neutral: {
      color: '#6b7280',       // Warm grey
      glowFilter: 'rgba(107, 114, 128, 0.5)',
      lightColor: '#9ca3af',  // Lighter grey
      lightEndColor: '#4b5563', // Darker grey
    },
    fear: {
      color: '#c0392b',       // Refined red
      glowFilter: 'rgba(192, 57, 43, 0.5)',
      lightColor: '#e74c3c',  // Lighter red
      lightEndColor: '#a93226', // Darker red
    },
  };
