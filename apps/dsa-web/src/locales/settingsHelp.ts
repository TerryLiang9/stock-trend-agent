...
const settingsHelpZhCN: SettingsHelpMap = {
  ...
  // Agent configuration
  // ------------------------------------------------------------------
  'settings.agent.MA_AGENT_WEIGHT_MOVING_AVERAGE': {
    title: 'A 股均线基线权重', summary: '均线基线在明日趋势五分类中的主导权重。',
    usage: '四项技术模型权重合计必须为 100%，且均线权重必须高于任一研究模型。',
    valueNotes: ['默认值为 70%。'], impact: ['影响综合趋势分和五分类结果。'], notes: ['仅用于研究，不构成交易指令。'],
  },
  'settings.agent.MA_AGENT_WEIGHT_WAVELET': {
    title: 'A 股小波模型权重', summary: '小波趋势研究模型的辅助权重。',
    usage: '调整后仍需满足四项权重合计为 100%。', valueNotes: ['默认值为 10%。'], impact: ['影响小波信号对综合趋势分的贡献。'], notes: ['仅用于研究，不构成交易指令。'],
  },
  'settings.agent.MA_AGENT_WEIGHT_ANALOG': {
    title: 'A 股历史相似日模型权重', summary: '历史相似日研究模型的辅助权重。',
    usage: '调整后仍需满足四项权重合计为 100%。', valueNotes: ['默认值为 10%。'], impact: ['影响历史相似日信号对综合趋势分的贡献。'], notes: ['仅用于研究，不构成交易指令。'],
  },
  'settings.agent.MA_AGENT_WEIGHT_LOGISTIC_6F': {
    title: 'A 股六因子模型权重', summary: '六因子逻辑回归研究模型的辅助权重。',
    usage: '调整后仍需满足四项权重合计为 100%。', valueNotes: ['默认值为 10%。'], impact: ['影响六因子信号对综合趋势分的贡献。'], notes: ['仅用于研究，不构成交易指令。'],
  },
...
const settingsHelpEnUS: SettingsHelpMap = {
  ...
  // ------------------------------------------------------------------
  'settings.agent.MA_AGENT_WEIGHT_MOVING_AVERAGE': {
    title: 'A-share MA baseline weight', summary: 'Dominant weight of the moving-average baseline in the five-level trend result.',
    usage: 'The four technical model weights must total 100%, and the MA weight must exceed each research model.',
    valueNotes: ['Default is 70%.'], impact: ['Affects the combined trend score and five-level state.'], notes: ['Research-only; not a trading instruction.'],
  },
  'settings.agent.MA_AGENT_WEIGHT_WAVELET': {
    title: 'A-share wavelet weight', summary: 'Supporting weight of the wavelet research model.',
    usage: 'The four weights must still total 100%.', valueNotes: ['Default is 10%.'], impact: ['Affects the wavelet contribution to the combined trend score.'], notes: ['Research-only; not a trading instruction.'],
  },
  'settings.agent.MA_AGENT_WEIGHT_ANALOG': {
    title: 'A-share analog weight', summary: 'Supporting weight of the historical analog research model.',
    usage: 'The four weights must still total 100%.', valueNotes: ['Default is 10%.'], impact: ['Affects the analog contribution to the combined trend score.'], notes: ['Research-only; not a trading instruction.'],
  },
  'settings.agent.MA_AGENT_WEIGHT_LOGISTIC_6F': {
    title: 'A-share six-factor weight', summary: 'Supporting weight of the six-factor logistic model.',
    usage: 'The four weights must still total 100%.', valueNotes: ['Default is 10%.'], impact: ['Affects the six-factor contribution to the combined trend score.'], notes: ['Research-only; not a trading instruction.'],
  },
  'settings.agent.AGENT_MODE': {
    title: 'Agent Mode',
