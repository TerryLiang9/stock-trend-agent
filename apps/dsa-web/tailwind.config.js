...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-purple-cyan': 'linear-gradient(135deg, hsla(var(--accent), 0.15) 0%, hsla(var(--primary), 0.1) 100%)',
        'gradient-card-border': 'linear-gradient(180deg, hsla(var(--accent), 0.3) 0%, hsla(var(--accent), 0.08) 50%, hsla(var(--primary), 0.15) 100%)',
        'gradient-cyan': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--primary) / 0.8) 100%)',
        'primary-gradient': 'linear-gradient(135deg, #c8a55a 0%, #b89540 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 0 20px rgba(200, 165, 90, 0.2)',
        'glow-purple': '0 0 20px rgba(0, 107, 84, 0.15)',
        'glow-success': '0 0 20px rgba(90, 158, 111, 0.2)',
        'glow-danger': '0 0 20px rgba(192, 57, 43, 0.2)',
        'cyan/20': '0 12px 28px rgba(200, 165, 90, 0.15)',
        'cyan/22': '0 18px 34px rgba(200, 165, 90, 0.18)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 20px rgba(200, 165, 90, 0.25)' },
          '50%': { boxShadow: '0 0 40px rgba(200, 165, 90, 0.4)' },
        },
      },
    },
  },
