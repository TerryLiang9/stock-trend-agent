...
WEB_SETTINGS_HIDDEN_FROM_UI = {
    # 趋势 Agent、ClickHouse 和服务启动参数仍通过 .env/部署配置管理；
    # 当前 Web 只提供趋势模型权重的组合编辑器。
    "ANSPIRE_API_KEYS",
    "MA_AGENT_ENABLED",
    "MA_AGENT_SCHEDULE_TIME",
    "MA_AGENT_SYMBOLS",
    "MA_AGENT_DATA_MODE",
    "MA_AGENT_ALLOW_MINUTE_FALLBACK",
    "MA_AGENT_NEWS_ENABLED",
    "MA_AGENT_TRADING_MODE",
    "MA_AGENT_LIVE_CONFIRMED",
    "MA_AGENT_KILL_SWITCH",
    "MA_AGENT_AUTO_PROMOTE",
    "MA_AGENT_MIN_EVALUATED_SAMPLES",
    ...
    "CLICKHOUSE_TICK_VOLUME_SEMANTICS",
    "AUTOMATION_ENABLED",
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MA_AGENT_WEIGHT_MOVING_AVERAGE": {
        "title": "A 股均线基线权重",
        "description": "A 股趋势预测中均线基线模型的裁决权重。四项权重合计必须为 1，且均线权重必须最大。",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0.0, "max": 1.0},
        "display_order": 70,
        "help_key": "settings.agent.MA_AGENT_WEIGHT_MOVING_AVERAGE",
        "examples": ["MA_AGENT_WEIGHT_MOVING_AVERAGE=0.70"],
        "docs": [{"label": "A 股趋势 Agent 编排说明", "href": "docs/trend-forecast-orchestration.md"}],
        "warning_codes": [],
    },
    "MA_AGENT_WEIGHT_WAVELET": {
        "title": "A 股小波模型权重",
        "description": "A 股趋势预测中小波研究模型的裁决权重。",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0.0, "max": 1.0},
        "display_order": 71,
        "help_key": "settings.agent.MA_AGENT_WEIGHT_WAVELET",
        "examples": ["MA_AGENT_WEIGHT_WAVELET=0.10"],
        "docs": [{"label": "A 股趋势 Agent 编排说明", "href": "docs/trend-forecast-orchestration.md"}],
        "warning_codes": [],
    },
    "MA_AGENT_WEIGHT_ANALOG": {
        "title": "A 股历史相似日模型权重",
        "description": "A 股趋势预测中历史相似日研究模型的裁决权重。",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0.0, "max": 1.0},
        "display_order": 72,
        "help_key": "settings.agent.MA_AGENT_WEIGHT_ANALOG",
        "examples": ["MA_AGENT_WEIGHT_ANALOG=0.10"],
        "docs": [{"label": "A 股趋势 Agent 编排说明", "href": "docs/trend-forecast-orchestration.md"}],
        "warning_codes": [],
    },
    "MA_AGENT_WEIGHT_LOGISTIC_6F": {
        "title": "A 股六因子模型权重",
        "description": "A 股趋势预测中六因子逻辑回归研究模型的裁决权重。",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0.0, "max": 1.0},
        "display_order": 73,
        "help_key": "settings.agent.MA_AGENT_WEIGHT_LOGISTIC_6F",
        "examples": ["MA_AGENT_WEIGHT_LOGISTIC_6F=0.10"],
        "docs": [{"label": "A 股趋势 Agent 编排说明", "href": "docs/trend-forecast-orchestration.md"}],
        "warning_codes": [],
    },
    "AGENT_BACKEND": {
