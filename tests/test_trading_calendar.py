...
class ComputeEffectiveRegionTestCase(unittest.TestCase):
    ...
    def test_single_region_open(self):
        self.assertEqual(trading_calendar.compute_effective_region("hk", {"cn", "hk", "us"}), "cn")
        self.assertEqual(trading_calendar.compute_effective_region("jp", {"jp"}), "")
        self.assertEqual(trading_calendar.compute_effective_region("kr", {"kr"}), "")

    def test_single_region_closed(self):
        self.assertEqual(trading_calendar.compute_effective_region("hk", {"cn", "us"}), "cn")
